...
class DualMCTS():
    ...
    def iter_explore(self,n_sample,model_path,docking_result,gen_csv,final_gen=False,model_type='NN'):
        self.gen_smis=set()
        df1=pd.read_csv('/public/home/chensheng/project/aixfuse/data/docking/results/rorgt_act_dual_XP_prop.csv')
        df2=pd.read_csv('/public/home/chensheng/project/aixfuse/data/docking/results/dhodh_act_dual_XP_prop.csv')
        self.get_p(df1,df2)
