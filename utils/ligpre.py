...
def ligpre(csv,mae,nchir,device='gpu'):

    with open('/public/home/chensheng/project/aixfuse2/utils/ligpre/simi.inp','w') as inp:
    ...
    njobs=ncpu*4
    with open('/public/home/chensheng/project/aixfuse2/utils/ligpre/simi.sh','w') as inp:
        inp.write('#!/bin/bash\n'
                    '#SBATCH --nodes=1\n'
                    f'#SBATCH -w {node}\n'
                    ...
                    f'/public/software/schrodinger/2020-3/ligprep -inp simi.inp -HOST localhost:{ncpu} -NJOBS {njobs} -TMPLAUNCHDIR -WAIT\n'
                    )
