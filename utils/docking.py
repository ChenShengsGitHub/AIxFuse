...
def docking(input,grid,prec='SP',path='/public/home/chensheng/project/aixfuse2/utils/docking',device='gpu'):
    ...
    with open(os.path.join(dir,'docking.sh'),'w') as inp:
        inp.write('#!/bin/bash\n'
                ...
                f'/public/software/schrodinger/2020-3/glide  docking.in -OVERWRITE -adjust -HOST localhost:{ncpu} -TMPLAUNCHDIR -WAIT'
                    )
